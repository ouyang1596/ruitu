...
public class LocationUtil {
	...
	public void initLocation() {
		...
		option.setLocationMode(LocationMode.Hight_Accuracy);// 可选，默认高精度，设置定位模式，高精度，低功耗，仅设备,高精度（Hight_Accuracy）会同时使用gps,wifi以及基站定位
	...
	public class MyLocationListener implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
			mLocationClient.stop();
			// 没有调用这个方法或导致Activity内存泄露
			mLocationClient.unRegisterLocationListener(this);
			if (mOnLocationListener != null) {
				mOnLocationListener.onReceiveLocation(location);
			}
			// Receive Location
			...
			// }
			// }
			// Log.i("bm", "city:" + location.getCity() + ";" + sb.toString());
		}
	}
