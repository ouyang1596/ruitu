...
public class CalendarView extends View implements View.OnTouchListener {
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		Log.d(TAG, "[onLayout] changed:" + (changed ? "new size" : "not change") + " left:" + left + " top:" + top + " right:" + right
				+ " bottom:" + bottom);
		if (changed) {
			surface.init();
		}
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(0, 0, surface.width, surface.weekHeight, surface.cellBgPaint);
		...
		for (int i = 0; i < 42; i++) {
			...
			// if (color == surface.dateTextColor || color ==
	...
	private void drawCellBg(Canvas canvas, int index, int color) {
		...
		canvas.drawRect(left, top, left + surface.cellWidth - surface.borderWidth, top + surface.cellHeight - surface.borderWidth,
				surface.cellBgPaint);
	}
	...
	private class Surface {
		private static final String RT_TRANSPARENCY = "#00000000";
		private static final String RT_TEXT_BG_GRAY = "#f8f8f8";
		private static final String RT_BLACK_TWO = "#666666";
		private static final String RT_BLUE = "#33a8ff";
		private static final String RT_TEXT_GRAY2 = "#aaaaaa";
		...
		public int weekBgColor = Color.parseColor(RT_TEXT_BG_GRAY);
		// private int textColor = Color.BLACK;
		private int weekTextColor = Color.parseColor(RT_BLACK_TWO);
		private int dateTextColor = Color.parseColor(RT_TEXT_GRAY2);
		// private int textColorUnimportant = Color.parseColor("#666666");
		private int btnColor = Color.parseColor("#666666");
		// private int borderColor = Color.parseColor("#00CCCCCC");
		private int borderColor = Color.parseColor(RT_TRANSPARENCY);
		public int todayNumberColor = Color.parseColor(RT_BLUE);
		...
		public void init() {
			...
			monthPaint.setColor(weekTextColor);
